 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
#define DSCP_CMD_OAI_SET_REPORT_NOTIFY_PERIOD                 (DSCP_OAI_CBASE + 0x14)
 ...
 *  - @ref DSCP_ERROR 操作失败；
 */
#define DSCP_CMD_OAI_SET_CHECK_LEAKING_PERIOD                  (DSCP_OAI_CBASE + 0x15)
 ...
 * @see
 */
#define DSCP_EVENT_OAI_REPORT_DATA                 			  (DSCP_OAI_EBASE + 0x04)
 ...
 * @see
 */
#define DSCP_EVENT_OAI_REPORT_SMEA_DATA                        (DSCP_OAI_EBASE + 0x05)
...
/**
  ...
  */
 #define DSCP_EVENT_DSI_CHECK_LEAKING_NOTICE               	  (DSCP_OAI_EBASE + 0x06)
