 ...
 * @return gstat Uint8，驱动全局寄存器的值
 */
#define DSCP_CMD_MCI_EXTRADEVICE_CONTROL           (DSCP_MCI_CBASE + 0x0D)
 ...
 * @note 该命令将立即返回，电机移动完成将以事件的形式上报。
 */
#define DSCP_CMD_MCI_MOTOR_MOVE_XYZ                 (DSCP_MCI_CBASE + 0x0E)

#define DSCP_CMD_MCI_MOTOR_RESET_XYZ                (DSCP_MCI_CBASE + 0x0F)
// *******************************************************************
// 事件
