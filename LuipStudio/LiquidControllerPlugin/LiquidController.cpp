...
LiquidController::LiquidController(DscpAddress addr)
    ...
    IExtPeristalticPump(new ExtPeristalticPumpInterface(addr)),
    IExtSolenoidValve(new ExtSolenoidValveInterface(addr))
{
...
LiquidController::~LiquidController()
{
    ...
    if (IExtPeristalticPump)
        delete IExtPeristalticPump;
    if (IExtSolenoidValve)
        delete IExtSolenoidValve;
}
...
ExtPeristalticPumpInterface *LiquidController::GetIExtPeristalticPump()
{
    return IExtPeristalticPump;
}
...
ExtSolenoidValveInterface *LiquidController::GetIExtSolenoidValve()
{
    return IExtSolenoidValve;
}
