...
* @return 返回状态，操作是否成功。
 */
bool PeristalticPumpInterface::SetMotionParam(int index, ExMotionParam param)
{
    Uint16 status = DscpStatus::Error;
    Uint8 cmdData[9];
 ...
 */
ExPumpStatus PeristalticPumpInterface::GetPumpStatus(int index)
{
 ...
 *  - @ref Stopped 泵操作被停止
 */
ExPumpResult PeristalticPumpInterface::ExpectPumpResult(long timeout)
{
