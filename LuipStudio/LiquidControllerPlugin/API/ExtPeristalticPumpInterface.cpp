 ...
 * @param[in] addr 设备地址。
 */
ExtPeristalticPumpInterface::ExtPeristalticPumpInterface(DscpAddress addr)
 ...
 * @return 总泵数目， Uint16。
 */
int ExtPeristalticPumpInterface::GetTotalPumps()
{
    Uint16 pumps = 0;
 ...
 */
float ExtPeristalticPumpInterface::GetPumpFactor(int index)
{
    float factor = 0;
 ...
 * @return 返回状态，操作是否成功。
 */
bool ExtPeristalticPumpInterface::SetPumpFactor(int index, float factor)
{
 ...
 */
ExMotionParam ExtPeristalticPumpInterface::GetMotionParam(int index)
{
    ExMotionParam param;
...
* @return 返回状态，操作是否成功。
 */
bool ExtPeristalticPumpInterface::SetMotionParam(int index, ExMotionParam param)
{
    Uint16 status = DscpStatus::Error;
    Uint8 cmdData[9];

    cmdData[0] = index;
    memcpy(cmdData+1, &param, sizeof(ExMotionParam));
 ...
 */
ExPumpStatus ExtPeristalticPumpInterface::GetPumpStatus(int index)
{
    ExPumpStatus status = ExPumpStatus::Idle;
 ...
 */
bool ExtPeristalticPumpInterface::StartPump(int index, RollDirection dir, float volume, float seep)
{
    Uint16 status = DscpStatus::Error;
    Uint8 cmdData[10] = {0};
 ...
 * @return 返回状态，操作是否成功。
 */
bool ExtPeristalticPumpInterface::StopPump(int index)
{
    Uint16 status = DscpStatus::Error;
 ...
 */
float ExtPeristalticPumpInterface::GetPumpVolume(int index)
{
    float volume = 0;
 ...
 *  - @ref Stopped 泵操作被停止
 */
ExPumpResult ExtPeristalticPumpInterface::ExpectPumpResult(long timeout)
{
    ExPumpResult pumpResult;
