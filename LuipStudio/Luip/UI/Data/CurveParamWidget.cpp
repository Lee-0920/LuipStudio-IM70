...
void CurveTableWidget::Resize(void)
{
     m_parameterTableWidget->setFixedSize(580,391);
     m_parameterTableWidget->setColumnWidth(4,70);
     m_parameterTableWidget->setColumnWidth(5,70);
}
