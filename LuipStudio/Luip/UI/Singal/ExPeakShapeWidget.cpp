...
ExPeakShape::ExPeakShape(QWidget *parent)
...
ExPeakShape::~ExPeakShape()
{

}

void ExPeakShape::InitCanvas()
{
...
void ExPeakShape::SetDisplayDays()
{
...
void ExPeakShape::SlotRangeChange()
{
    if(m_Adaptive)
    {
        m_Adaptive = false;
...
void ExPeakShape::SlotPeakhighChange(QString arg)
{
    double value = arg.toDouble();
    m_yDisplayPeakHigh = value;
}

void ExPeakShape::SlotAddTopY()
{
...
void ExPeakShape::SlotSubstractTopY()
{
...
void ExPeakShape::SlotAddBottomY()
{
...
void ExPeakShape::SlotSubtractBottomY()
{
...
void ExPeakShape::SlotUpdaterData()
{
    int len;
    double time[m_range] = {0};
