setting.ui.profile.system =
{
    ...
    readPrivilege = RoleType.Maintain,
    {
        ...
        text = "通道配置",
        {
            name = "targetMap.ChannelOne.enable",
            text = "通道一",
            type = DataType.Bool,
        ...
        {
            name = "targetMap.ChannelTwo.enable",
            text = "通道二",
            type = DataType.Bool,
            writePrivilege=  RoleType.Maintain,
            readPrivilege = RoleType.Maintain,
        ...
        {
            name = "targetMap.ChannelThree.enable",
            text = "通道三",
            type = DataType.Bool,
            writePrivilege=  RoleType.Maintain,
            readPrivilege = RoleType.Maintain,
        ...
        {
            name = "targetMap.ChannelFour.enable",
            text = "通道四",
            type = DataType.Bool,
            writePrivilege=  RoleType.Maintain,
            readPrivilege = RoleType.Maintain,
        ...
        {
            name = "targetMap.ChannelFive.enable",
            text = "通道五",
            type = DataType.Bool,
            writePrivilege=  RoleType.Maintain,
            readPrivilege = RoleType.Maintain,
        ...
        {
            name = "targetMap.ChannelSix.enable",
            text = "通道六",
            type = DataType.Bool,
            writePrivilege=  RoleType.Maintain,
            readPrivilege = RoleType.Maintain,
        ...
        text = "COD转换系数",
        {
            ...
            checkValue = function(value)
                if setting.ui.profile.system.fourDecimalWithNegativePattern(value) == true and tonumber(value) ~= 0 then
                    ...
                    return string.format("%.6f", config.system.channelFactor[1].curveK)
                end
            end,
        },
        {
            name = "channelFactor[1].curveB",
            text = "通道一截距",
            type = DataType.Double,
            writePrivilege=  RoleType.Maintain,
            readPrivilege = RoleType.Maintain,
            ...
            checkValue = function(value)
                if setting.ui.profile.measureParam.fourDecimalWithNegativePattern(value) == true then
                    ...
                    return string.format("%.6f", config.system.channelFactor[1].curveB)
                end
            end,
        },
        {
            name = "channelFactor[2].curveK",
            text = "通道二斜率",
            type = DataType.Double,
            writePrivilege=  RoleType.Maintain,
            readPrivilege = RoleType.Maintain,
            ...
            checkValue = function(value)
                if setting.ui.profile.system.fourDecimalWithNegativePattern(value) == true and tonumber(value) ~= 0 then
                    ...
                    return string.format("%.6f", config.system.channelFactor[2].curveK)
                end
            end,
        },
        {
            name = "channelFactor[2].curveB",
            text = "通道二截距",
            type = DataType.Double,
            writePrivilege=  RoleType.Maintain,
            readPrivilege = RoleType.Maintain,
            ...
            checkValue = function(value)
                if setting.ui.profile.measureParam.fourDecimalWithNegativePattern(value) == true then
                    ...
                    return string.format("%.6f", config.system.channelFactor[2].curveB)
                end
            end,
        },
        {
            name = "channelFactor[3].curveK",
            text = "通道三斜率",
            type = DataType.Double,
            writePrivilege=  RoleType.Maintain,
            readPrivilege = RoleType.Maintain,
            ...
            checkValue = function(value)
                if setting.ui.profile.system.fourDecimalWithNegativePattern(value) == true and tonumber(value) ~= 0 then
                    ...
                    return string.format("%.6f", config.system.channelFactor[3].curveK)
                end
            end,
        },
        {
            name = "channelFactor[3].curveB",
            text = "通道三截距",
            type = DataType.Double,
            writePrivilege=  RoleType.Maintain,
            readPrivilege = RoleType.Maintain,
            ...
            checkValue = function(value)
                if setting.ui.profile.measureParam.fourDecimalWithNegativePattern(value) == true then
                    ...
                    return string.format("%.6f", config.system.channelFactor[3].curveB)
                end
            end,
        },
        {
            name = "channelFactor[4].curveK",
            text = "通道四斜率",
            type = DataType.Double,
            writePrivilege=  RoleType.Maintain,
            readPrivilege = RoleType.Maintain,
            ...
            checkValue = function(value)
                if setting.ui.profile.system.fourDecimalWithNegativePattern(value) == true and tonumber(value) ~= 0 then
                    ...
                    return string.format("%.6f", config.system.channelFactor[4].curveK)
                end
            end,
        },
        {
            name = "channelFactor[4].curveB",
            text = "通道四截距",
            type = DataType.Double,
            writePrivilege=  RoleType.Maintain,
            readPrivilege = RoleType.Maintain,
            ...
            checkValue = function(value)
                if setting.ui.profile.measureParam.fourDecimalWithNegativePattern(value) == true then
                    ...
                    return string.format("%.6f", config.system.channelFactor[4].curveB)
                end
            end,
        },
        {
            name = "channelFactor[5].curveK",
            text = "通道五斜率",
            type = DataType.Double,
            writePrivilege=  RoleType.Maintain,
            readPrivilege = RoleType.Maintain,
            ...
            checkValue = function(value)
                if setting.ui.profile.system.fourDecimalWithNegativePattern(value) == true and tonumber(value) ~= 0 then
                    ...
                    return string.format("%.6f", config.system.channelFactor[5].curveK)
                end
            end,
        },
        {
            name = "channelFactor[5].curveB",
            text = "通道五截距",
            type = DataType.Double,
            writePrivilege=  RoleType.Maintain,
            readPrivilege = RoleType.Maintain,
            ...
            checkValue = function(value)
                if setting.ui.profile.measureParam.fourDecimalWithNegativePattern(value) == true then
                    ...
                    return string.format("%.6f", config.system.channelFactor[5].curveB)
                end
            end,
        },
        {
            name = "channelFactor[6].curveK",
            text = "通道六斜率",
            type = DataType.Double,
            writePrivilege=  RoleType.Maintain,
            readPrivilege = RoleType.Maintain,
            ...
            checkValue = function(value)
                if setting.ui.profile.system.fourDecimalWithNegativePattern(value) == true and tonumber(value) ~= 0 then
                    ...
                    return string.format("%.6f", config.system.channelFactor[6].curveK)
                end
            end,
        },
        {
            name = "channelFactor[6].curveB",
            text = "通道六截距",
            type = DataType.Double,
            writePrivilege=  RoleType.Maintain,
            readPrivilege = RoleType.Maintain,
            ...
            checkValue = function(value)
                if setting.ui.profile.measureParam.fourDecimalWithNegativePattern(value) == true then
                    ...
                    return string.format("%.6f", config.system.channelFactor[6].curveB)
                end
            end,
        },
        {
            name = "channelFactor[7].curveK",
            text = "标样斜率",
            type = DataType.Double,
            writePrivilege=  RoleType.Maintain,
            readPrivilege = RoleType.Maintain,
            ...
            checkValue = function(value)
                if setting.ui.profile.system.fourDecimalWithNegativePattern(value) == true and tonumber(value) ~= 0 then
                    ...
                    return string.format("%.6f", config.system.channelFactor[7].curveK)
                end
            end,
        },
        {
            name = "channelFactor[7].curveB",
            text = "标样截距",
            type = DataType.Double,
            writePrivilege=  RoleType.Maintain,
            readPrivilege = RoleType.Maintain,
            ...
            checkValue = function(value)
                if setting.ui.profile.measureParam.fourDecimalWithNegativePattern(value) == true then
                    ...
                    return string.format("%.6f", config.system.channelFactor[7].curveB)
                end
            end,
        },
    },
