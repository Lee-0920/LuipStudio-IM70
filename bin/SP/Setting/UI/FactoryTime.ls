setting.ui.factoryTime =
{
    defaultRestore = function(userType)
        ...
        if userType == RoleType.Super then
            ...
            config.hardwareConfig.stoveTempCalibrate.calibrationVoltage = defaultTable.stoveTempCalibrate.calibrationVoltage
            config.hardwareConfig.stoveTempCalibrate.negativeInput = defaultTable.stoveTempCalibrate.negativeInput
            config.hardwareConfig.stoveTempCalibrate.referenceVoltage = defaultTable.stoveTempCalibrate.referenceVoltage
